    ...
    <div class="px-4 pt-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="md:flex gap-16 row-gap-10 mb-8 items-center">
            ...
            <div class="mt-5 md:mt-0">
                <p class="text-lg text-primary flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-1 text-gray-700">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                    </svg>

                    <a href="mailto:contact@brechtvdt.be" class="items-center text-xl md:text-2xl hover:text-primary/80">
                        contact@brechtvdt.be
                    </a>
                </p>

                <p class="text-lg text-gray-400 mt-2 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-1 text-gray-700">
        ...
        <div class="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
            ...
            <div class="flex items-center mt-4 space-x-3 sm:mt-0">
                ...
                <a href="https://www.linkedin.com/in/brecht-vanderdonckt-83607249/" title="LinkedIn">
                    <svg class="w-6 h-6 text-primary hover:text-gray-100" aria-hidden="true"
